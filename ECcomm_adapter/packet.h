...
const unsigned maxloops = 8000;    // clock cycles. This assumes 80 MHz operation.
...
public:
  ...
  Packet(byte reg_rx, byte reg_tx, byte priority, byte address, byte data1, byte data2, byte data3)
    : Packet(reg_rx, reg_tx) {
